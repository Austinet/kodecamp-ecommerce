      ...
      <main>
        <section>
                  ...
                  <div className="flex flex-col md:flex-row gap-3 md:gap-5 mb-3 md:mb-6">
                    <div className="md:w-[50%]">
                      ...
                      <input
                        ...
                        required
                      />
                      <span className={`text-red-600 ${newUserErrors.firstName ? "block": "hidden"}`}>
                    ...
                    <div className="md:w-[50%]">
                      ...
                      <input
                        ...
                        required
                      />
                      <span  className={`text-red-600 ${newUserErrors.lastName ? "block": "hidden"}`}>
                        Must be more than 2 characters, letters only
                      </span>
                    </div>
                  </div>
                  <div className="flex flex-col md:flex-row gap-3 md:gap-5 mb-3 md:mb-6">
                    <div className="md:w-[50%]">
                      ...
                      <input
                        ...
                        required
                      />
                      <span  className={`text-red-600 ${newUserErrors.phoneNumber ? "block": "hidden"}`}>
                    ...
                    <div className="md:w-[50%]">
                      ...
                      <input
                        ...
                        required
                      />
                      <span className={`text-red-600 ${newUserErrors.email ? "block": "hidden"}`}>
                        Email already used
                      </span>
                    </div>
                  </div>
                  <div className="flex flex-col md:flex-row gap-3 md:gap-5 mb-3 md:mb-6">
                    <div className="md:w-[50%]">
                      ...
                      {/* <img
                        ...
                        role="button"
                      /> */}
                      <span  className={`text-red-600 ${newUserErrors.password ? "block": "hidden"}`}>
                    ...
                    <div className="md:w-[50%]">
                      ...
                      {/* <img
                        ...
                        role="button"
                      /> */}
                      <span  className={`text-red-600 ${newUserErrors.confirmPassword ? "block": "hidden"}`}>
          ...
          <div
            className={`${
              success ? "" : "hidden"
            } absolute bg-[#000000d7] w-full h-full top-0 left-0 flex items-center justify-center z-20`}
          >
